...
class TestLoadRecipesWithSpecifiedIngredient {
	...
	void testNoRecipeInFile() throws IOException {
		...
		ArrayList<Recipe> recipes = load.loadRecipesWithSpecifiedIngredient(ingredient1);
		assertEquals(0, recipes.size(), "Checks the number of recipes loaded");
	}

	@Test
	void testNoRecipeInFileHasSpecificIngredient() throws IOException {
		...
		LoadRecipesFromFile load = new LoadRecipesFromFile();
		ArrayList<Recipe> recipes = load.loadRecipesWithSpecifiedIngredient(ingredient2);
		assertEquals(0, recipes.size());

	}

	@Test
	void testOneRecipeInFileHasSpecificIngredient() throws IOException {
		ArrayList<Ingredient> listOfIngredients = new ArrayList<Ingredient>();
		Ingredient ingredient1 = new Ingredient("Turkey", "Meat");
		listOfIngredients.add(ingredient1);
		Recipe recipe = new Recipe("ThanksGiving Turkey", listOfIngredients);
	...
	@Test
	void testOneRecipeInFileHasSpecificIngredientWithMultipleIngredients() throws IOException {
		ArrayList<Ingredient> listOfIngredients = new ArrayList<Ingredient>();
		Ingredient ingredient1 = new Ingredient("Turkey", "Meat");
		Ingredient ingredient2 = new Ingredient("Cranberry", "Fruit");
		listOfIngredients.add(ingredient1);
	...
	@Test
	void testTwoRecipesInFileWithSpecificIngredient() throws IOException {
		ArrayList<Ingredient> listOfIngredients = new ArrayList<Ingredient>();
		Ingredient ingredient1 = new Ingredient("Turkey", "Meat");
		Ingredient ingredient2 = new Ingredient("Cranberry", "Fruit");
		listOfIngredients.add(ingredient1);
